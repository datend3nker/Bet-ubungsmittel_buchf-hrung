    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StufenId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BtmBestandsbuchNr = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stufen", x => x.StufenId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BtmBestandsbuchNr = table.Column<int>(nullable: false),
                    StufenNummer = table.Column<int>(nullable: false),
                    Einheit = table.Column<char>(nullable: false),
                    ...
                    StufenId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Einträge", x => x.EintragId);
                    table.ForeignKey(
                        name: "FK_Einträge_Stufen_StufenId",
                        column: x => x.StufenId,
                        principalTable: "Stufen",
                        principalColumn: "StufenId",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateIndex(
                name: "IX_Einträge_StufenId",
                table: "Einträge",
                column: "StufenId");
